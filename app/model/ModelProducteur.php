<?php
/**
 * Il s'agit du modèle s'inspirant de la table producteur de notrebase de données
 */
...
// retourne une liste des id
 ...
 public static function delete($id) {
  ...
  try{
      $database = Model::getInstance();
      $producteur = $database->query($query2);
      $producteur = $producteur->fetchAll(PDO::FETCH_CLASS, "ModelProducteur");
      $statement = $database->exec($query);
      $results = $producteur;
      return $results;
  
  } catch (PDOException $e){
      $message = "Echec de la supression . Il est peut être présent dans la table récolte. Erreur : ".$e->getMessage();
      $results = $message;
      return $results;
  }
 }
